...
import base64, cgi, email.utils, functools, hmac, itertools, mimetypes,\
        os, re, subprocess, sys, tempfile, threading, time, warnings, types

try:  # pragma: no cover - Python < 3.12 kept imp
...
class _ImportRedirect(object):
    def __init__(self, name, impmask):
        ...
        self.module = sys.modules.setdefault(name, _new_module(name))
